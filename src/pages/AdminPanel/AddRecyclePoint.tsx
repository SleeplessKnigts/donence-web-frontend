import { Button, Center, FormControl, HStack, Input, Select } from "@chakra-ui/react";
...
export const AddRecyclePoint: React.FC<AddRecyclePointProps> = ({ currentPoint }) => {
    ...
    return (
        <form onSubmit={handleSubmit(onSubmit)}>
            <FormControl>
                <Map setCurrentLoc={setCurrentLoc} addPoint={true} currentLoc={currentLoc} />
            </FormControl>
            <HStack margin="4" spacing="8">
                ...
                <FormControl>
                    <Select variant="filled" name="recyclePointPlaceType" ref={register({ required: true })}>
            ...
            <Center>
                <Button colorScheme="teal" m={2} isLoading={formState.isSubmitting} type="submit">
                    Ekle
                </Button>
            </Center>
        </form>
